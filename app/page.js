          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="cyber-border bg-black/50 p-8 text-center border border-cyan-400/30 hover:border-cyan-400 hover:neon-glow transition-all group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3 cyber-body">
                  <p className="font-bold text-cyan-100 group-hover:text-cyan-400 transition-colors break-all">PROFESSIONAL_PROJECT_MANAGEMENT</p>
                  <p className="font-bold text-cyan-100 group-hover:text-cyan-400 transition-colors break-all">PROFESSIONAL_DATA_ANALYTICS</p>
                  <p className="font-bold text-cyan-100 group-hover:text-cyan-400 transition-colors break-all">PROFESSIONAL_CLOUD_DATA_ANALYTICS</p>
                </div>
              </div>
            ...
            <div className="cyber-border bg-black/50 p-8 text-center border border-cyan-400/30 hover:border-cyan-400 hover:neon-glow transition-all group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="font-bold text-cyan-100 group-hover:text-cyan-400 transition-colors cyber-body break-all">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 cyber-font text-cyan-100 group-hover:text-cyan-400 transition-colors break-all">EMAIL_INTERFACE</h3>
            ...
            <div className="group cyber-border bg-black/50 backdrop-blur-sm p-8 border border-cyan-400/30 relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-2 cyber-font text-cyan-100 break-all">LOCATION_DATA</h3>
          ...
          <div className="cyber-border bg-black/50 backdrop-blur-sm p-8 border border-cyan-400/30 relative overflow-hidden">
            <div className="absolute inset-0 cyber-grid opacity-5"></div>
            <h3 className="text-2xl font-bold mb-4 cyber-font text-purple-400 neon-text relative z-10 break-all">READY_TO_MAKE_IMPACT</h3>
