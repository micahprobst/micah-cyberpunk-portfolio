        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="cyber-border bg-gray-900/50 p-8 border border-cyan-400/30">
            <div className="space-y-6 cyber-body text-lg leading-relaxed">
              ...
              <p className="mb-4">
                My journey into the iceberg that is social control began with some technical questions: why do AI systems develop sycophantic behaviors, telling users what they want to hear rather than what they need to know? <a href="/documents/ai-sycophancy-epistemic-vice.pdf" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline font-semibold">[paper]</a> What kind of semantic understanding do LLMs actually possess in a philosophical sense? <a href="/documents/beyond-binary-understanding.pdf" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline font-semibold">[paper]</a> How are AI systems shaping our epistemic systems and relationship with knowledge itself? <a href="/documents/The_Crisis_of_Epistemic_Agency.pdf" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline font-semibold">[paper]</a> This final inquiry into artificial intelligence's impact on human epistemic agency revealed something more disturbing than ignorant reward mechanisms. I discovered that <b>the very architecture of our information systems transforms us from thinking beings into passive consumers of processed conclusions.</b>
              </p>
              <p className="mb-6">
