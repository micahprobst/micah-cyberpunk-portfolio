        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="cyber-border bg-gray-900/50 p-8 border border-cyan-400/30">
            <div className="space-y-6 cyber-body text-lg leading-relaxed">
              ...
              <p className="mb-4">
                My journey into the iceberg that is social control began with some technical questions: why do AI systems develop sycophantic behaviors, telling users what they want to hear rather than what they need to know? <a href="/documents/The_Crisis_of_Epistemic_Agency.pdf" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline font-semibold">[The Crisis of Epistemic Agency]</a> What kind of semantic understanding do LLMs actually possess in a philosophical sense? <a href="/documents/beyond-binary-understanding.pdf" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline font-semibold">[Beyond Binary Understanding]</a> How are AI systems shaping our epistemic systems and relationship with knowledge itself? <a href="/documents/ai-sycophancy-epistemic-vice.pdf" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline font-semibold">[AI Sycophancy & Epistemic Vice]</a> This final inquiry into artificial intelligence's impact on human epistemic agency revealed something more disturbing than ignorant reward mechanisms. I discovered that <b>the very architecture of our information systems transforms us from thinking beings into passive consumers of processed conclusions.</b>
              </p>
              <p className="mb-6">
              ...
              <p className="mb-4">
                This piece led me to zoom out and adopt the <b>Three Pillars Framework</b> for understanding effective social control: the simultaneous ownership of material reality (how we survive), psychological reality (how we think and relate), and spiritual reality (what we believe about meaning, truth, and transcendence). Every system of domination operates through all three dimensions, creating subjects who experience their subjugation not as oppression but as natural necessity, personal failure, or spiritual duty.
              </p>
              <p className="mb-6">
                Philosophy offers us the analytical tools for dissecting these deeper structures. By drawing on dialectical materialism, phenomenology, contemplative traditions, and more, I examine how consciousness itself becomes a site of <b>domination</b>—how human mental and spiritual capacity gets enslaved to serve systems that prevent authentic development and meaningful connection.
              </p>

              <h2 className="text-2xl cyber-font text-purple-400 mb-6 neon-text">Personal Stakes in Universal Questions</h2>
              <p className="mb-4">
                This isn't abstract academic analysis. Growing up in a system designed to identify and cultivate "high achievers" while sorting the rest into categories of managed decline, I've witnessed how meritocracy operates as a sophisticated tool in the arsenal of social control. <b>The same competitive pressures that enabled my early academic success also created psychological conditions</b>—chronic insecurity, utilitarian thinking, disconnection from my fellow man—that work to consistently anchor me to these systems of social control.
              </p>
              <p className="mb-6">
                My generation has inherited a world where the technologies that could enable unprecedented human flourishing instead accelerate ecological destruction, social fragmentation, and spiritual exhaustion. <b>We've been trained to see this as inevitable, to adapt ourselves to systems rather than questioning the systems themselves.</b> I—for one—have had enough. Philosophical inquiry reveals that our current arrangements represent specific, historical, and changeable patterns of consciousness—not eternal truths about human nature. So let’s do something about it.
              </p>

              <h2 className="text-2xl cyber-font text-purple-400 mb-6 neon-text">The Work of Consciousness Liberation</h2>
              <p className="mb-4">
                The deepest form of social control operates through the <b>imprisonment of imagination itself</b>—the inability to conceive that things could be fundamentally different. My writings aim to liberate your imagination by revealing how current systems arose from particular spiritual, psychological, and material conditions, and how different conditions of consciousness would naturally create different forms of social organization.
              </p>
              <p className="mb-6">
                This is philosophy as spiritual practice, analysis as a form of love—love for human potential and deep concern for authentic flourishing. Each piece serves what the revolutionary thinkers understood as <b>The Great Work:</b> awakening people to their own brilliant potential beyond what current systems require or allow.
              </p>

              <h2 className="text-2xl cyber-font text-purple-400 mb-6 neon-text">An Invitation to Transformation</h2>
              <p className="mb-4">
                I spent my early life trying to exploit these systems for my benefit, while simultaneously being their victim on the basis of class and race.The position I write from is that of someone who has seen many faces of our current arrangements and grown to realize that our world is a collection of systems designed to benefit others at my expense. <b>This isn't the detached analysis of academic philosophy</b>, but the engaged inquiry of someone wrestling with how to live truthfully in a world structured by lies.
              </p>
              <p className="mb-4">
                My work synthesizes insights from revolutionary movements, economics, politics, history, culture, philosophy, spirituality and more. But the goal isn't to provide answers so much as to <b>awaken the capacity for authentic questioning</b>—the kind of deep inquiry that transforms not just understanding but being itself.
              </p>
              <p className="mb-8">
                The future depends on our ability to develop forms of consciousness that can see through the current illusions AND imagine and create alternative systems that serve life rather than power. <b>This is the most important work any of us can do:</b> the liberation of human consciousness from systems that diminish our capacity for wisdom, empathy, and authentic creative response to the beautiful and terrible mystery of existence.
              </p>
