        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="cyber-border bg-gray-900/50 p-8 border border-cyan-400/30">
            <div className="space-y-6 cyber-body text-lg leading-relaxed">
              ...
              <p className="mb-4">
                My journey into the iceberg that is social control began with a technical question: why do AI systems develop sycophantic behaviors, telling users what they want to hear rather than what they need to know? This inquiry into artificial intelligence's impact on human epistemic agency—our capacity to actively form genuine knowledge—revealed something more disturbing than ignorant reward mechanisms. I discovered that <b>the very architecture of our information systems transforms us from thinking beings into passive consumers of processed conclusions.</b>
              </p>
              <p className="mb-6">
